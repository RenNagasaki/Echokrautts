...
#
#  Model weights are NOT baked in. They are non-commercial (F5 finetunes
#  CC-BY-NC-4.0, XTTS-v2 CPML) — redistributing them inside a public image
#  would be a licensing problem. The entrypoint downloads them on first start
#  into the /data/models volume instead.
# ============================================================================
...
print(f"ok: torch {torch.__version__}, no torchcodec, transformers pin holds")
PY
